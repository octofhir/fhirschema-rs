...
mod tests {
    ...
    fn test_no_type_overlaps() {
        let resource_types: std::collections::HashSet<_> =
            FhirTypeDefinitions::resource_types().iter().collect();
        let primitive_types: std::collections::HashSet<_> =
            FhirTypeDefinitions::primitive_types().iter().collect();
        let complex_types: std::collections::HashSet<_> =
            FhirTypeDefinitions::complex_types().iter().collect();
        let special_types: std::collections::HashSet<_> =
            FhirTypeDefinitions::special_types().iter().collect();
